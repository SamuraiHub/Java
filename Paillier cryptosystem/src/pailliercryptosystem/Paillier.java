...
public class Paillier
{
    ...
    public BigInteger randomZStarNSquare()
    {
        ...
        do
        {
            r = new BigInteger(modLength * 2, new SecureRandom());
        }
    ...
    // return public key as an array {n, g}
    public BigInteger[] publicKey()
    {
      ...
      // return private key as an array {lambda, mu}
    public BigInteger[] privateKey()
    {
        BigInteger[] pvtKey = new BigInteger[2];
        pvtKey[0] = lambda;
        pvtKey[1] = mu;
