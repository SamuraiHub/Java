...
public class sendsms {
    ...
    {
        /* sendsms.init();
         sendsms.server = "http://192.168.1.100:8080/";
         sendsms.user = "test";
         sendsms.password = "test";
         sendsms.phonenumber = "+20108220415";
         sendsms.text = "This is a test message";
         sendsms.send(); */
        
        BigDecimal d = new BigDecimal("2.718281828459045235360287471352662497757247093699").pow(100);
        d = (BigDecimal.valueOf(1.0)).divide(d, new MathContext(55));
        for(int i = 100; i < 138; i++)
        {
            BigDecimal e = (BigDecimal.valueOf(100).pow(i, new MathContext(55))).multiply(d);
            e = e.divide(new BigDecimal(fact(i)), new MathContext(55));
            System.out.println("Prob: "+e.doubleValue());
        }
    }
