...
public class Hash24 implements Serializable {
  ...
  static class node
  {
      ...
      {
          NextElement = new node(n);
      }
  }
   
   public static void main(String[] args)
   {
       List<Integer> ns = new ArrayList<>(1000000);
       List<Integer> ns1 = new ArrayList<>(1000000);
       List<Integer> ns2 = new ArrayList<>(1000000);
       List<Integer> ns3 = new ArrayList<>(1000000);
       node ns4 = new node(0); node ns5 = ns4;
       ...
       for(int i = 0; i<1000000; i++)
       {
           ...
           ns2.add(i);
           ns3.add(i);
           if(i > 0) {ns5.AddNext(i); ns5 = ns5.Next(); }
       }
       ...
       System.out.println("T for normal loop: " + (End - Start)/100.0);
       ...
       for(int j = 0; j < 100; j++)
       {
         for(Iterator I = ns1.iterator(); I.hasNext();)
         {
           if(5000000-k == (int) I.next())
           {
              I.remove(); k++;
              break;
           }
       ...
       System.out.println("T for normal Iterator: " + (End - Start)/100.0);
      ...
      k = 0;
       ...
       for(int j = 0; j < 100; j++)
       {
          ns2.remove((Integer) (5000000-k));
          k++; 
       }
       
       End = System.currentTimeMillis();
       
       System.out.println("T for forEach loop: " + (End - Start)/100.0);
       ...
       for(int j = 0; j < 100; j++)
       {
         for(ListIterator I = ns3.listIterator(); I.hasNext();)
         {
           if(5000000-k == (int) I.next())
           {
              I.remove(); k++;
       ...
       System.out.println("T for list iterator: " + (End - Start)/100.0);
       ...
       for(int j = 0; j < 100; j++)
       {
         for(ns5 = ns4; ns5 != null; ns5 = ns5.Next())
         {
           if(5000000-k == ns5.getData())
           {
              k++;
              break;
           }
       ...
       System.out.println("T for LinkedList: " + (End - Start)/100.0);
   }
