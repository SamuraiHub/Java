 ...
 * project. It was imported and modified with permission, courtesy of Nathan
 * Fiedler.</p>
 *
 * @author Muaz Aljarhi
 */
public class FibonacciHeap
{
     ...
     * value.
     */
    public void decreaseKey(entry x)
    {
        entry y = x.parent;
     ...
     */
    protected void cascadingCut(entry y)
    {
        entry z = y.parent;
...
class entry
{
     ...
     */
    public entry(long key, int node)
    {
        right = this;
        left = this;
        this.node = node;
