...
public class Columnar_Transposition_Cipher {
    ...
    public Columnar_Transposition_Cipher(){}
    ...
    public static void main(String[] args) throws IOException{
     ...
     Columnar_Transposition_Cipher CC = new Columnar_Transposition_Cipher();

        System.out.print("Columnar Transposition Cipher Encryption");
