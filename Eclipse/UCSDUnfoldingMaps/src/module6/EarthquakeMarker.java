...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public void showTitle(PApplet pg, float x, float y)
	{
		...
		pg.stroke(110);
		pg.fill(255,255,255);
		pg.rect(x, y + 15, pg.textWidth(title) +6, (float) 18, (float) 5);
	...
	public int compareTo(EarthquakeMarker arg1) {
		// TODO Auto-generated method stub
		return this.getMagnitude() > arg1.getMagnitude() ? -1 : this.getMagnitude() < arg1.getMagnitude() ? 1 : 0;
	}
