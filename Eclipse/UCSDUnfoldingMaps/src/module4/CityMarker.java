...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		pg.fill(139,0,0); //color dark red
        ...
        //float xc12 = (0.0f)*(float) Math.cos(2.0943951023931955);
		//float xs12 = (0.0f)*(float) Math.sin(2.0943951023931955);
		float yc12 = (5.0f)*(float) Math.cos(2.0943951023931955);
		float ys12 = (5.0f)*(float) Math.sin(2.0943951023931955);
		
		pg.triangle(x, y-7.0f, x-ys12, y-yc12, x+ys12, y-yc12);
