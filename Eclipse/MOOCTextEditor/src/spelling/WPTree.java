...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		//if both words are equal just return both words
		...
		root = new WPTreeNode(word1,null);
				...
				while(!queue.isEmpty())
				{
					WPTreeNode r = queue.removeFirst();
					List<String> neb = nw.distanceOne(r.getWord(), true);
					...
					for(String s : neb)
					{
						if (!visited.contains(s)) 
						{
                            ...
                            WPTreeNode c = r.addChild(s);
							if(s.equals(word2))
								return c.buildPathToRoot();
							visited.add(s);
							queue.add(c);
						}
					}
...
class WPTreeNode {
    ...
    private String word;
    private LinkedList<WPTreeNode> children;
	 ...
	 */
    public LinkedList<WPTreeNode> getChildren() {
