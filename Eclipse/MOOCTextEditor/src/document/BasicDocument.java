...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		//List<String> AbbvWords = Arrays.asList(
			//	"e.g.", "etc.", "i.e.", "Mr.", "Mrs.", "Prof.", "Rev.", "Assn.", "Ave.", "Dept.", "est.", "fig.", "Inc.", "obj.", "Trans.");
		List<String> Words = getTokens("[A-Za-z0-9)]+[.?!]+|[A-za-z ]\\z");
		int i = Words.size(); 
		
		//if(getText().length() != 0 && (Words.size() == 0 || !getText().trim().endsWith(Words.get(Words.size()-1)))) { i++; }
