...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		if(v || (word.charAt(word.length()-1) == 'e' && cs == 0) || word.charAt(word.length()-1) == 'a' ||
				word.charAt(word.length()-1) == 'i' || word.charAt(word.length()-1) == 'o' || word.charAt(word.length()-1) == 'u' || word.charAt(word.length()-1) == 'y')
		{
			cs++;
		}
