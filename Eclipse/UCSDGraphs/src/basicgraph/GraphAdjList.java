...
public class GraphAdjList extends Graph {
	...
	private ArrayList<ArrayList<Integer>> adjListsMap;
	
	/** 
	 * Create a new empty Graph
	 */
	public GraphAdjList () {
		adjListsMap = new ArrayList<ArrayList<Integer>>();
	}
	...
	public List<Integer> getInNeighbors(int v) {
		...
		for (int i = 0; i < adjListsMap.size(); i++) 
		{
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> gd2 = new ArrayList<Integer>();
		 for(int v1 : getNeighbors(v))
		 {
			 gd2.addAll(getNeighbors(v1));
		 }
	...
	public String adjacencyString() {
		...
		for (int v = 0; v < adjListsMap.size(); v++) {
			s += "\n\t"+v+": ";
