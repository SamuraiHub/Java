...
public class ServerView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            ...
            aboutBox = new ServerAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ServerApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(server.ServerApp.class).getContext().getActionMap(ServerView.class, this);
        jButton1.setAction(actionMap.get("StartServer")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(server.ServerApp.class).getContext().getResourceMap(ServerView.class);
    ...
    public void StartServer() {
        try{
        Helpers.init(txtLog);
        txtLog.append("Whatta noob/r/n");
        server.KnockKnockServer.StartServer();
        
        System.out.println(txtLog.getText());
    }
